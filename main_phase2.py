...
def run_pipeline() -> None:
    ...
    feature_cols = [
        ...
        "age",
        "jockey_weight",
        "jockey_weight_diff_from_race_mean",
        "race_horse_count",
        "horse_weight",
        "horse_weight_diff",
        "horse_past_runs",
        "horse_past_avg_rank",
        "horse_past_win_rate",
        "horse_past_place_rate",
        "horse_avg_passage_rate",
        "distance_diff",
        "horse_recent3_avg_rank",
        "horse_recent3_avg_last3f",
        "days_since_prev_race",
        "jockey_past_win_rate",
        "jockey_past_place_rate",
